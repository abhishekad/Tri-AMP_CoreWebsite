  ...
  return (
    <>
      ...
      <div className="min-h-[calc(100vh-150px)] flex flex-col items-center justify-center px-6 py-20 text-center relative overflow-hidden">
        ...
        >
          <div className="w-24 h-24 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-cyan-500/30">
          ...
          >
            ...
            <div className="space-y-2 text-left">
              <Label htmlFor="name-lexa" className="text-slate-300">Your Name</Label>
            ...
            <div className="space-y-2 text-left">
              <Label htmlFor="email-lexa" className="text-slate-300">Email Address</Label>
              <div className="relative">
            ...
            <Button 
              ...
              className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-lg py-3 rounded-xl"
            >
